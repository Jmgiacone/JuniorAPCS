...
public class LifeTester
{
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        //2d Arrays ftw!
        String[][] grid = new String[rowSize][columnSize],
                newGrid;
        ...
        for(int i = 0; i < coordStrings.length; i++)
        {
                ...
                /*This is cool, i'm splitting the string where both 
                numbers will have blank spaces, then i'll just trim off the 
                 fat... whilst parsing them to integers. 
                 Triple method inception ^_^*/
                row = Integer.parseInt(coordStrings[i].substring(0, 3).
                        trim());
                column = Integer.parseInt(coordStrings[i].substring(3).
                        trim());
